...
const seoContent = {
  en: {
    ...
    faqs: [
      { question: 'Is ZeFile free to use?', answer: 'Yes! The free plan lets you send up to 5 GB per transfer. Starter and Pro plans unlock higher limits and lower platform fees.' },
      ...
      { question: 'How large can my files be?', answer: 'Up to 5 GB on the free plan, 20 GB on Starter, and 50 GB on Pro. Files are uploaded in chunks so even large transfers are reliable.' },
  ...
  fr: {
    ...
    faqs: [
      { question: 'ZeFile est-il gratuit ?', answer: 'Oui ! Le plan gratuit vous permet d\'envoyer jusqu\'\u00e0 5 Go par transfert. Les plans Starter et Pro offrent des limites plus \u00e9lev\u00e9es et des frais r\u00e9duits.' },
      ...
      { question: 'Quelle taille maximale pour mes fichiers ?', answer: 'Jusqu\'\u00e0 5 Go sur le plan gratuit, 20 Go sur Starter et 50 Go sur Pro. Les fichiers sont envoy\u00e9s par morceaux pour une fiabilit\u00e9 maximale.' },
