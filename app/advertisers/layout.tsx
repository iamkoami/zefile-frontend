...
const seoContent = {
  en: {
    title: 'Advertise with Us - Reach Creative Professionals',
  ...
  fr: {
    title: 'Publicité - Atteignez les professionnels créatifs',
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        'en': `${SITE_URL}/advertisers`,
        'fr': `${SITE_URL}/advertisers`,
        'x-default': `${SITE_URL}/advertisers`,
      },
    },
  };
}
  ...
  return (
    <>
      <BreadcrumbJsonLd items={[
        ...
        { name: 'Advertisers', url: `${SITE_URL}/advertisers` },
      ]} />
      {children}
    </>
  );
