      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-5 px-5 py-3.5 md:px-7 md:py-4">
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <p className="text-sm text-[#171717] dark:text-gray-200">
              {t("bannerText")}{" "}
              <Link
                href="/privacy"
          ...
          <div className="flex items-center gap-2 md:gap-3 shrink-0">
            <button
              ...
              className="text-sm font-medium text-[#171717] dark:text-gray-200 underline underline-offset-4 hover:no-underline transition-all whitespace-nowrap px-1 py-1.5"
            >
              {t("customize")}
            </button>
            <button
              onClick={handleRefuse}
              className="text-sm font-medium text-[#171717] dark:text-gray-200 border border-gray-300 dark:border-gray-600 hover:border-[#171717] px-5 py-2 rounded-full transition-colors whitespace-nowrap"
            >
              {t("essentialOnly")}
            </button>
            <button
          ...
          <div className="overflow-hidden min-h-0">
            <div className="px-5 md:px-7 pb-5 md:pb-6">
              <div className="border-t border-gray-100 dark:border-gray-700 pt-4">
                <h3 className="text-base font-bold text-[#171717] dark:text-gray-100 mb-4">
                  {t("preferencesTitle")}
                </h3>
                ...
                <div className="flex items-start justify-between py-3">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 mt-0.5 shrink-0 ${
                      analyticsToggle ? "bg-[#87E64B]" : "bg-gray-200 dark:bg-gray-600"
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full transition-transform duration-200 shadow-sm ${
                        analyticsToggle ? "translate-x-6 bg-[#171717]" : "translate-x-1 bg-white"
                      }`}
                    />
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between gap-3 mt-3 pt-3 border-t border-gray-100 dark:border-gray-700">
                  <Link
                    href="/privacy"
                    className="text-xs text-gray-500 dark:text-gray-400 underline hover:text-[#171717] transition-colors"
                  >
                    {t("privacyPolicyLink")}
                  </Link>
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="text-sm text-gray-500 dark:text-gray-400 hover:text-[#171717] transition-colors px-3 py-2"
                    >
                      {t("back")}
                    </button>
                    <button
