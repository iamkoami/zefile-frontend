    ...
    <section className="border-t border-gray-200 pt-6 mt-6">
      ...
      <div className="flex items-start justify-between py-3">
        <div className="flex-1 pr-4">
          <p className="font-medium text-[#171717]">{t("logoutAllDevices")}</p>
        ...
        <button
          ...
          className="px-4 py-2 border border-gray-300 rounded hover:bg-gray-50 text-sm font-bold text-[#171717] disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
