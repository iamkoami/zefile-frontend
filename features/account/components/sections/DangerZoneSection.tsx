            ...
            <div className="flex-1">
              ...
              <div className="mt-3 flex items-center gap-4">
                ...
                <button
                  ...
                  className="text-sm font-medium text-[#5E53E0] hover:underline disabled:opacity-50"
                >
    ...
    <section className="border-t-2 border-red-200 pt-6 mt-6">
      ...
      <div className="flex items-start justify-between py-3">
        ...
        <button
          ...
          className="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 transition-colors"
            ...
            >
              ...
              <div className="flex justify-center mb-6">
                <div className="w-20 h-20 flex items-center justify-center bg-red-100 rounded-full">
                  <Trash className="w-12 h-12 text-red-600" strokeWidth={1.5} />
                </div>
              </div>
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                >
                  {isDeleting ? t('deleteAccountRequesting') : t('deleteAccountConfirmButton')}
                </button>
              </div>
            </div>
          </div>
