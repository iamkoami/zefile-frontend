...
const PhoneAuthForm: React.FC<PhoneAuthFormProps> = ({
  ...
  return (
    <>
      {/* Turnstile widget must stay mounted across phone→OTP step transitions */}
      {captchaEnabled && (
        <Turnstile
          ref={turnstileRef}
          siteKey={siteKey}
            ...
            <div className="ze-phone-input-wrapper flex items-end gap-4 mb-12">
              ...
              <div className="flex-1 relative">
                <input
                  ...
                  className="ze-phone-input w-full font-bold border-none outline-none focus:outline-none bg-transparent text-gray-900 dark:text-[oklch(0.91_0_0)] pb-4 placeholder:text-2xl placeholder:opacity-40 placeholder:font-normal"
